...
exports.createPagination = function (pagination, options) {
    ...
    if (page === 1) {
        ...
        n = page - 1;
        template = template + '<li class="class="page-item"><a class="page-link" href="?page=' + n + queryParams + '">' + leftText + '</a></li>';
    }
    ...
    while (i < limit && i < pageCount) {
        ...
        if (start === page) {
            ...
            template = template + '<li><a class="page-link" href="?page=' + n + queryParams + '">' + n + '</a></li>';
        }
